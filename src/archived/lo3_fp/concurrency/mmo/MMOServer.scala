package archived.lo3_fp.concurrency.mmo
...
object MMOServer {
  def main(args: Array[String]): Unit = {
    ...
    system.scheduler.scheduleAtFixedRate(FiniteDuration(0, duration.MILLISECONDS), FiniteDuration(33, duration.MILLISECONDS), mmo, Update)
  }
}
