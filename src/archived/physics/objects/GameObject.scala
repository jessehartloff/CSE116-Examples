...
class GameObject(var location: PhysicsVector, var dimensions: PhysicsVector) {
  ...
  /**
    ...
    * functionality, but will be used while testing objective 3 of the archived.physics engine. When testing
  ...
  /**
    ...
    *
    * Note: This functionality will not be used in the archived.physics engine assignment
    */
  ...
  /**
    * Called by the archived.physics engine whenever the object collides with a dynamic object. By default, an object does not
